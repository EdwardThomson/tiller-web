    ...
    async function getShipments() {
        ...
        if (qtyTotal > 0) {
            ...
            const payload = {
                ...
                qtyBlack: $('#lrw-id-checkout__qty--black').qtyBlack,
                qtyGrey: $('#lrw-id-checkout__qty--grey').qtyGrey,
                qtySilver: $('#lrw-id-checkout__qty--silver').qtySilver,
                qtyOrange: $('#lrw-id-checkout__qty--orange').qtyOrange,
                qtyTotal,
